                ...
                <div class="coin-price-inputs">
                  ...
                  <div class="prices-div">
                    <div class="token-price-div">
                      AVAX: <b-form-input class="price-input" type="number" v-model="bnbPrice" />
                    </div>
                    <div class="token-price-div">
...
export default Vue.extend({
  ...
  methods: {
    ...
    async fetchPrices() {
      const response = await axios.get('https://api.coingecko.com/api/v3/simple/price?ids=cryptoblades,avalanche-2&vs_currencies=usd');
