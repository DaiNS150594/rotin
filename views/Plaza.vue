...
export default {
  ...
  async created() {
    const recruitCost = await this.contracts.RotInHell.methods.mintCharacterFee().call({ from: this.defaultAccount });
    const hellRecruitCost = await this.contracts.RotInHell.methods.usdToHell(recruitCost).call();
